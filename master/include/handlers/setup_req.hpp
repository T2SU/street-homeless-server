...
#ifndef STREET_HOMELESS_SERVER_SETUP_REQ_HPP
#define STREET_HOMELESS_SERVER_SETUP_REQ_HPP
...
{
    struct setup_req : public hl::packet_handler<master_session>
    {
    public:
...
#endif //STREET_HOMELESS_SERVER_SETUP_REQ_HPP
